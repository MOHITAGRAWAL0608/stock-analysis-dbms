...
--
-- The ten base tickers go in here. 02b_expand_tickers.sql adds the other
-- 130 with INSERT IGNORE, so it has to run after this file, not before.
-- =====================================================================

USE stockdb;

-- ---------------------------------------------------------------------
-- Base tickers. These take company_id 1-10, which the holdings and
-- watchlist rows below refer to directly.
-- ---------------------------------------------------------------------
INSERT INTO Companies (ticker, company_name, sector, exchange, currency) VALUES
('RELIANCE',  'Reliance Industries Ltd',        'Oil Gas & Fuels',    'NSE','INR'),
...
('LT',        'Larsen & Toubro Ltd',            'Capital Goods',      'NSE','INR'),
('WIPRO',     'Wipro Ltd',                      'Information Tech',   'NSE','INR'),
('MARUTI',    'Maruti Suzuki India Ltd',        'Automobile',         'NSE','INR'),
('SUNPHARMA', 'Sun Pharmaceutical Inds Ltd',    'Healthcare',         'NSE','INR');
